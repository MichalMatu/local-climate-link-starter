export const pl = {
  ...
  hardware: {
    ...
    shelly: {
      ...
      bleWifiTitle: 'Połącz to gniazdko z Wi-Fi',
      bleWifiSsid: 'Nazwa sieci Wi-Fi',
      bleWifiPassword: 'Hasło Wi-Fi',
      bleWifiConnect: 'Połącz z Wi-Fi',
      bleWifiConnecting: 'Łączę z Wi-Fi…',
      bleWifiConfirmed: 'Konfiguracja Wi-Fi zapisana.',
      bleWifiPending:
        'Konfiguracja Wi-Fi wysłana. Gniazdko może jeszcze łączyć się z siecią.',
      check: 'Sprawdź',
      ...
      scannerBehavior:
        'AP: połącz się bezpośrednio z Wi-Fi Shelly — adres to zwykle 192.168.33.1. STA: Shelly jest w Twojej sieci Wi-Fi — użyj zakresu tej sieci. Skan pokazuje także już dodane gniazdka, oznacza je jako Dodane i sprawdza cały wybrany zakres aż do końca albo Stop.',
      scanning: 'Skanuję',
    ...
    sensor: {
      ...
      pvvxMobileOnly:
        'Operacje Xiaomi/PVVX wymagają aplikacji mobilnej i połączenia BLE.',
    ...
    rule: {
      ...
      saveTarget: 'Zmiany zostaną zapisane w: {name}.',
      restoreFromShellyTitle: 'Przywrócić ustawienia z gniazdka?',
      restoreFromShellyDescription:
        'Bieżące wartości formularza zostaną zastąpione konfiguracją działającą na tym gniazdku. Nic nie zostanie jeszcze zapisane na urządzeniu.',
      restoreFromShellyConfirm: 'Przywróć ustawienia',
      ...
      liveSourcePhoneBle: 'BLE telefonu',
      liveSourcePlugBle: 'BLE gniazdka',
      identityRecoveredRuntime: 'Odzyskany z runtime',
      additionalSensors: 'Dodatkowe termometry',
      sensorAggregation: 'Agregacja odczytów',
      sensorAggregationAvg: 'Średnia',
      sensorAggregationMin: 'Minimum',
      sensorAggregationMax: 'Maksimum',
      sensorAggregationFirstValid: 'Pierwszy poprawny odczyt',
      editSaved: 'Zmiany automatyki zapisane.',
      saveChanges: 'Zapisz zmiany',
      savingChanges: 'Zapisuję zmiany…',
      saveChangesTitle: 'Zapisz zmienioną automatykę w Shelly',
    ...
    diagnostics: {
      ...
      groupDecisionHint:
        'Pomiar, progi, decyzja i oba stany przekaźnika w jednym miejscu.',
      groupRuntime: 'Skrypt i czas',
      groupRuntimeHint: 'Stan skryptu, hash konfiguracji i zegar Shelly.',
      ...
      groupSensor: 'BLE i sensor',
      groupSensorHint: 'Źródło pomiaru, ostatni pakiet, bateria i RSSI.',
      groupShelly: 'Telemetria Shelly',
      groupShellyHint: 'Moc, napięcie, prąd, energia i temperatura gniazdka.',
      input: 'Input',
      output: 'Output',
