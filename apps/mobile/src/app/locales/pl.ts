export const pl = {
  ...
  hardware: {
    ...
    diagnostics: {
      ...
      groupRuntimeHint: 'Stan skryptu, ostatnia decyzja, progi reguły i zegar Shelly.',
      groupSensor: 'Termometr',
      groupSensorHint: 'Ostatni pakiet BLE i dane użyte przez regułę.',
      groupShelly: 'Gniazdko',
      groupShellyHint: 'Przekaźnik, pobór energii i stan fizycznego Shelly.',
