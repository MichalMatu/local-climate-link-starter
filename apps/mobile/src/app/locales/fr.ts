...
export const fr = {
  ...
  dashboard: {
    ...
    systemsLabel: 'Automatisations enregistrées',
    currentValues: 'Valeurs actuelles',
    temperature: 'Température',
    humidity: 'Humidité',
    vpd: 'VPD',
    output: 'Sortie',
    thresholds: 'Seuils ON / OFF',
    sensor: 'Capteur',
  ...
  hardware: {
    ...
    nav: {
      ...
      backToRule: 'Retour à la règle',
      developerDiagnostics: 'Diagnostic développeur',
      developerDiagnosticsHint:
        'État brut du script, du BLE et de Shelly. À utiliser uniquement pour le diagnostic et la maintenance.'
    },
    safety: {
    ...
    shelly: {
      ...
      bleWifiTitle: 'Connecter cette prise au Wi-Fi',
      bleWifiSsid: 'Nom du réseau Wi-Fi',
      bleWifiPassword: 'Mot de passe Wi-Fi',
      bleWifiConnect: 'Connecter au Wi-Fi',
      bleWifiConnecting: 'Connexion au Wi-Fi…',
      bleWifiConfirmed: 'Configuration Wi-Fi enregistrée.',
      bleWifiPending:
        'Configuration Wi-Fi envoyée. La prise est peut-être encore en connexion.',
      check: 'Vérifier',
      ...
      scannerBehavior:
        'AP : connectez-vous directement au Wi-Fi Shelly — l’adresse est généralement 192.168.33.1. STA : Shelly est sur votre Wi-Fi — utilisez la plage de ce réseau. Le scan affiche aussi les prises déjà ajoutées, les marque comme Ajoutée et vérifie toute la plage jusqu’à la fin ou jusqu’à Stop.',
    ...
    sensor: {
      ...
      pvvxMobileOnly:
        'Les opérations Xiaomi/PVVX nécessitent l’application mobile et une connexion BLE.',
    ...
    rule: {
      ...
      advancedDisclosureHint:
        'Limites de sécurité et tolérance à un signal faible ou absent. Les valeurs par défaut conviennent à la plupart des installations.',
      openAdvanced: 'Ouvrir les options avancées',
      developerTools: 'Outils développeur',
      developerToolsHint:
        'Aperçu et opérations du script, plus diagnostic Shelly complet. Inutile pour la configuration normale.',
      openDeveloperDiagnostics: 'Ouvrir le diagnostic technique',
      vpdAssistTitle: 'Assistance VPD',
      vpdAssistHint:
        'Ajuste éventuellement le point de fonctionnement dans les seuils configurés. Ne modifie pas les limites de sécurité.',
      ...
      loadingScriptFromShelly: 'Chargement depuis Shelly',
      loadScriptDone: 'Réglages Shelly chargés dans le formulaire.',
      ...
      editContextHint:
        'L’enregistrement modifiera les réglages actuellement actifs sur cette prise.',
      saveTarget: 'Les modifications seront enregistrées sur : {name}.',
      restoreFromShellyTitle: 'Restaurer les réglages depuis la prise ?',
      restoreFromShellyDescription:
        'Les valeurs actuelles du formulaire seront remplacées par la configuration active sur cette prise. Rien ne sera encore écrit sur l’appareil.',
      restoreFromShellyConfirm: 'Restaurer les réglages',
      ...
      liveSourcePhoneBle: 'BLE du téléphone',
      liveSourcePlugBle: 'BLE de la prise',
      identityRecoveredRuntime: 'Récupéré du runtime',
      additionalSensors: 'Thermomètres supplémentaires',
      sensorAggregation: 'Agrégation des mesures',
      sensorAggregationAvg: 'Moyenne',
      sensorAggregationMin: 'Minimum',
      sensorAggregationMax: 'Maximum',
      sensorAggregationFirstValid: 'Première mesure valide',
      editSaved: 'Modifications enregistrées.',
      saveChanges: 'Enregistrer les modifications',
      savingChanges: 'Enregistrement…',
      saveChangesTitle: 'Enregistrer l’automatisation modifiée sur Shelly',
    ...
    diagnostics: {
      ...
      groupDecisionHint:
        'Mesure, seuils, décision et deux états du relais au même endroit.',
      groupRuntime: 'Script et horloge',
      groupRuntimeHint: 'État du script, hash de configuration et horloge Shelly.',
      ...
      groupSensor: 'BLE et capteur',
      groupSensorHint: 'Source de mesure, dernier paquet, batterie et RSSI.',
      groupShelly: 'Télémétrie Shelly',
      groupShellyHint: 'Puissance, tension, courant, énergie et température de la prise.',
      input: 'Input',
      output: 'Output',
