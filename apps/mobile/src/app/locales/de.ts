...
export const de = {
  ...
  hardware: {
    ...
    shelly: {
      ...
      bleWifiTitle: 'Steckdose mit WLAN verbinden',
      bleWifiSsid: 'WLAN-Name',
      bleWifiPassword: 'WLAN-Passwort',
      bleWifiConnect: 'Mit WLAN verbinden',
      bleWifiConnecting: 'WLAN-Verbindung wird hergestellt…',
      bleWifiConfirmed: 'WLAN-Konfiguration gespeichert.',
      bleWifiPending:
        'WLAN-Konfiguration gesendet. Die Steckdose verbindet sich möglicherweise noch.',
      check: 'Prüfen',
      ...
      scannerBehavior:
        'AP: Direkt mit dem Shelly-WLAN verbinden — die Adresse ist normalerweise 192.168.33.1. STA: Shelly ist in deinem WLAN — verwende den Bereich dieses Netzwerks. Der Scan zeigt auch bereits hinzugefügte Steckdosen, markiert sie als Hinzugefügt und prüft den gesamten Bereich bis zum Ende oder bis Stop gedrückt wird.',
      scanning: 'Scanne',
    ...
    rule: {
      ...
      liveSourcePhoneBle: 'Telefon-BLE',
      liveSourcePlugBle: 'Plug-BLE',
      identityRecoveredRuntime: 'Aus Runtime wiederhergestellt',
      additionalSensors: 'Zusätzliche Thermometer',
      sensorAggregation: 'Messwert-Aggregation',
      sensorAggregationAvg: 'Durchschnitt',
      sensorAggregationMin: 'Minimum',
      sensorAggregationMax: 'Maximum',
      sensorAggregationFirstValid: 'Erster gültiger Messwert',
      editSaved: 'Automationsänderungen gespeichert.',
      saveChanges: 'Änderungen speichern',
      savingChanges: 'Änderungen werden gespeichert…',
      saveChangesTitle: 'Geänderte Automation auf Shelly speichern',
