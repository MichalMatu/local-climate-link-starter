...
export const en = {
  ...
  hardware: {
    ...
    metrics: {
      ...
      relay: 'Relay',
      relayRule: 'Automation output',
      shellyRelay: 'Actual relay',
    ...
    shelly: {
      ...
      bleWifiTitle: 'Connect this plug to Wi-Fi',
      bleWifiSsid: 'Wi-Fi network name',
      bleWifiPassword: 'Wi-Fi password',
      bleWifiConnect: 'Connect to Wi-Fi',
      bleWifiConnecting: 'Connecting to Wi-Fi…',
      bleWifiConfirmed: 'Wi-Fi configuration saved.',
      bleWifiPending: 'Wi-Fi configuration sent. The plug may still be connecting.',
      check: 'Check',
      ...
      scannerBehavior:
        'AP: connect directly to Shelly Wi-Fi — the address is usually 192.168.33.1. STA: Shelly is on your Wi-Fi — use that network range. The scan also shows already added plugs, marks them as Added, and checks the full selected range until it finishes or you press Stop.',
      scanning: 'Scanning',
    ...
    sensor: {
      ...
      pvvxMobileOnly:
        'Xiaomi/PVVX operations require the mobile app and a BLE connection.',
    ...
    rule: {
      ...
      saveTarget: 'Changes will be saved to: {name}.',
      restoreFromShellyTitle: 'Restore settings from the plug?',
      restoreFromShellyDescription:
        'The current form values will be replaced with the configuration running on this plug. Nothing will be written to the device yet.',
      restoreFromShellyConfirm: 'Restore settings',
      ...
      liveSourcePhoneBle: 'Phone BLE',
      liveSourcePlugBle: 'Plug BLE',
      identityRecoveredRuntime: 'Recovered from runtime',
      additionalSensors: 'Additional thermometers',
      sensorAggregation: 'Reading aggregation',
      sensorAggregationAvg: 'Average',
      sensorAggregationMin: 'Minimum',
      sensorAggregationMax: 'Maximum',
      sensorAggregationFirstValid: 'First valid reading',
      editSaved: 'Automation changes saved.',
      saveChanges: 'Save changes',
      savingChanges: 'Saving changes…',
      saveChangesTitle: 'Save the edited automation to Shelly',
      ...
      vpdWorkingRange: 'Working range: {min}–{max}{unit} · {metric}',
