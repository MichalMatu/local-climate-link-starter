...
function vr(v,a,b,m){return typeof v==="number"&&isFinite(v)&&v>=a&&v<=b?Math.round(v*m):null;}
function sm(d){if(!d||!Array.isArray(d.g)||!Array.isArray(d.y)||!Array.isArray(d.q)||d.g.length<6)return null;var g=d.g,y=d.y,q=d.q,p=d.p,o=Array.isArray(p)&&typeof p[0]==="boolean"?p[0]:g[5],f=typeof g[0]==="number"&&typeof y[2]==="number"&&typeof q[4]==="number"&&y[2]*1000-g[0]<=q[4]*1000;if(typeof o!=="boolean")return null;return[f?vr(g[1],-100,200,10):null,f?vr(g[2],0,100,10):null,o?1:0];}
