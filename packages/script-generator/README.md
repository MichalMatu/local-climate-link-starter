...
Tests cover deterministic output, generator-to-decoder runtime round trips, failsafe sections, strict script byte budgets, invalid config, unreplaced placeholders, Xiaomi composite temperature/humidity windows, and snapshots for Xiaomi and TP357 minimal runtime profiles.
