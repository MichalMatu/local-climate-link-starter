...
# Preserve the canonical handoff commit from main; the feature branch deliberately
# left this file untouched.
test "$(git rev-parse HEAD:docs/HANDOFF_NEXT_CHAT.md)" = "$(git rev-parse $MAIN_BASE:docs/HANDOFF_NEXT_CHAT.md)"
...
echo FINAL_MAIN_HANDOFF_BLOB="$(git rev-parse HEAD:docs/HANDOFF_NEXT_CHAT.md)"
