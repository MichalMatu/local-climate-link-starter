...
# Find visual declarations that bypass vars/tokens. Exclude custom-property declarations and 0/100%/auto/inherit/currentColor.
...
for p in sorted(mobile.rglob('*Screen.tsx')) + sorted(mobile.rglob('*Detail.tsx')):
    text=p.read_text()
