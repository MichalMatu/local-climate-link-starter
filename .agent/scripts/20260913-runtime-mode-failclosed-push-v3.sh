...
p.write_text(s)
PY
pnpm exec prettier --write apps/mobile/src/screens/hardware-setup/pages/ShellySetupPresentation.tsx apps/mobile/src/__tests__/hardware-setup.test.tsx
pnpm --filter @lcl/mobile test -- src/__tests__/hardware-setup.test.tsx
pnpm --filter @lcl/mobile typecheck
pnpm quality:repo
git add apps/mobile/src/screens/hardware-setup/pages/ShellySetupPresentation.tsx apps/mobile/src/__tests__/hardware-setup.test.tsx
