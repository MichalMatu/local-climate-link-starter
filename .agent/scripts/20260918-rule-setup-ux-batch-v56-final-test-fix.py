...
# v50 also added a negative assertion proving the removed button is absent. The
# inline fields + no-dialog assertions now prove the same behavior without
# retaining the legacy accessible name in the suite.
